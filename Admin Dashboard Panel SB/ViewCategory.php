...
<body id="page-top">
    ...
    <div class="card shadow mb-4  d-flex justify-content-center align-items-center">
        <div class="card-header py-3">
            <h3 class="m-0 font-weight-bold text-dark">Categories</h3>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="text-center table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        $select_category_data = mysqli_query($con, " SELECT * FROM `p_category` ");

                        while ($fetch_category_data = mysqli_fetch_assoc($select_category_data)) {
