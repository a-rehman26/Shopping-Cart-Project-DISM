...
$product_id = $_GET['PRODUCTidCheckout'];

$results = $con->query("SELECT * FROM cart WHERE product_id = " . $product_id);
                ...
                <div class="col-12 col-md-8 col-lg-6 pb-5">
                    ...
                    <div class="card border-gray rounded-0">
                        ...
                        <div class="card-body p-3">
                            <div class="input-group-text">Pay With <img src="Pimages/logo_JazzCash.png"></div>
