        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form">
                    <!-- <div id="success"></div> -->
                    <form method="post" name="" id="" novalidate="">
                    ...
                    <!-- php contact form data insert to mysql  -->
                    <?php
                    ...
                    if (isset($_POST['btnSubmitContact'])) {
                        ...
                        $insert_query = mysqli_query($con, " INSERT INTO `contact`( `name`, `email`, `subject`, `message`) VALUES ('$name','$email','$subject','$message') ");
                    ...
                    ?>
                            <script>
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Thanks for contacting us We respond to you very soon',
            ...
            <div class="col-lg-5 mb-5">
                ...
                <div class="d-flex flex-column mb-3">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Street, Karachi, Pakistan</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>a9889817@gmail.com</p>
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+92 3112682258</p>
                </div>
                <div class="d-flex flex-column">
                    <h5 class="font-weight-semi-bold mb-3">Store 2</h5>
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Street, Lahore, Pakistan</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>a9889817@gmail.com</p>
                    <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+92 3112682258</p>
                </div>
            </div>
        </div>
    </div>
